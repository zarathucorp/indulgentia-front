    ...
    <main className="flex flex-col">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mt-2">
              연구노트 작성에 에너지를 소모하지 마세요. Git 활동만으로 자동으로
              연구노트가 완성됩니다.
            </p>
            <p className="text-lg md:text-xl lg:text-2xl">
              그저 노트 다운로드 후 제출하기만 하면 신경쓸 필요가 없습니다.
            </p>
            <Link href="/inquiry">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-400">
              소프트웨어 R&D를 진행하시나요? 모든 Git 활동이 기록되어, 따로
              연구노트를 준비 할 필요가 없습니다.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-4">
              ...
              <h3 className="text-xl font-bold">
                GitHub 데이터를 자동으로 연구노트로 전환
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                GitHub 등 Git에서의 활동만으로 정부에서 인정하는 전자연구노트
                자동작성이 가능합니다.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                GitHub 활동 이후 평균 1분 이내에 노트가 업데이트됩니다.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                블록체인을 통한 시점 인증으로 전자연구노트의 요건을 모두
                만족합니다.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 lg:py-32">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <Tabs className="w-full" defaultValue="join">
            <TabsList className="grid grid-cols-3 gap-4 mb-8 h-100">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 space-y-4">
                  <div className="relative group flex justify-center">
                    {/* <Image
								...
								/> */}
                    <ArcadeEmbed
                      url="https://demo.arcade.software/zQZzQI4JBZb5wBfgcKfU?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
                      title="연구실록 - 회원가입"
                    />
                  </div>
                  {/* <p className="text-gray-600 dark:text-gray-400">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 space-y-4">
                  <div className="relative group flex justify-center">
                    {/* <Image
								...
								/> */}
                    <ArcadeEmbed
                      url="https://demo.arcade.software/lJIIuwyVG0udDw5pZ2cC?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
                      title="연구실록 - 팀 생성"
                    />
                  </div>
                  {/* <p className="text-gray-600 dark:text-gray-400">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 space-y-4">
                  <div className="relative group flex justify-center">
                    {/* <Image
								...
								/> */}
                    <ArcadeEmbed
                      url="https://demo.arcade.software/Ub33ZpumCmM20zJTMnux?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
                      title="연구실록 - 노트 생성"
                    />
                  </div>
                  {/* <p className="text-gray-600 dark:text-gray-400">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-4">
              ...
              <h3 className="text-xl font-bold">
                연구실록에 대해 더 자세히 알고 싶으신가요?
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                <Button>
                  <a
                    href="https://zarathu.gitbook.io/rndsillog-docs"
                    target="_blank"
...
export function ArcadeEmbed({
  ...
  return (
    <div
      style={{
        position: "relative",
        paddingBottom: "calc(51.48437500000001% + 41px)",
        height: 0,
        width: "80%",
        display: "flex",
