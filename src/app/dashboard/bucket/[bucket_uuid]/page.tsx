...
import NotedownloadForm from "@/components/modules/dashboard/bucket/NotedownloadForm";
...
export default function Note() {
  ...
  const {
    ...
    `${process.env.NEXT_PUBLIC_API_URL}/dashboard/note/list/${params.bucket_uuid}`,
    fetcher
  );
  ...
  useEffect(() => {
    const hasVistedDashboardNote = localStorage.getItem(
      "hasVistedDashboardNote"
    );
    console.log("hasVistedDashboardNote", hasVistedDashboardNote);
    if (!hasVistedDashboardNote) {
      startOnborda("dashboard-note");
      localStorage.setItem("hasVistedDashboardNote", "true");
    }
  }, [startOnborda]);
  ...
  return (
    <>
      ...
      <div
        id="onborda-step2"
        className="grid xs:grid-cols-1 sm:grid-cols-[3fr_1fr] gap-6 p-6 sm:p-10 "
      >
        <div className="space-y-4">
          <div id="onborda-step3" className="grid gap-2">
        ...
        <div className="space-y-4">
          ...
          <div id="onborda-step7" className="flex items-center gap-2">
            <Popover>
