...
export function AccountForm() {
  ...
  const [accountRemoveModalOpen, setAccountRemoveModalOpen] =
  ...
  useEffect(() => {
    const hasVistedAccountSetting = localStorage.getItem(
      "hasVistedAccountSetting"
    );
    console.log("hasVistedAccountSetting", hasVistedAccountSetting);
    if (!hasVistedAccountSetting) {
      startOnborda("setting-account");
      localStorage.setItem("hasVistedAccountSetting", "true");
    }
  }, [startOnborda]);
  ...
  return (
    <Form {...form}>
      ...
      >
        <div id="onborda-step2" className="grid grid-cols-2 gap-4">
          <FormField
                  ...
                  <FormLabel>
                    ...
                    <Tooltip delayDuration={100}>
                      ...
                      <TooltipContent>
                        ...
                        <p>
                          이 성은 연구노트 작성자로 활용됩니다. 성을
                          변경하더라도 이미 생성된 연구노트 PDF에는 영향을
                          끼치지 않습니다.
                        </p>
                      </TooltipContent>
                    </Tooltip>
        ...
        <Button id="onborda-step5" type="submit">
          설정 업데이트
        </Button>
        <Button
          id="onborda-step6"
        ...
        {userInfo && (
          <AccountRemoveModal
            ...
            setIsOpen={setAccountRemoveModalOpen}
            userInfo={userInfo}
