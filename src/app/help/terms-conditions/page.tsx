  ...
  return (
		<div className="container mx-auto">
			<div className="max-w-3xl mx-auto">
				<h1 className="text-3xl font-bold my-4 text-gray-900 dark:text-gray-100">서비스 이용약관</h1>
        <TermsSection
          title="제1조(목적)"
          description="이 약관은 차라투 주식회사 (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다."
          contents={[
        ...
        <TermsSection
          title="제2조(정의)"
          description="이 약관에서 사용하는 주요 용어의 정의는 다음과 같습니다."
          contents={[
        ...
        <TermsSection
          title="제3조(약관 외 준칙)"
          description="이 약관에서 정하지 아니한 사항에 대해서는 법령 또는 회사가 정한 서비스의 개별약관, 운영정책 및 규칙 등(이하 세부지침)의 규정에 따릅니다. 또한 본 약관과 세부지침이 충돌할 경우에는 세부지침에 따릅니다."
          contents={[
        ...
        <TermsSection
          ...
          description=""
          contents={[
            "이 약관은 차라투 주식회사(이)가 제공하는 모든 인터넷서비스에 게시하여 공시합니다. '회사'는 ‘전자상거래 등에서의 소비자보호에 관한 법률(이하 '전자상거래법'이라 함)', '약관의 규제에 관한 법률(이하 '약관규제법'이라 함)', '전자문서 및 전자거래 기본법(이하 '전자문서법'이라 함)', ‘전자금융거래법 ‘, '정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법'이라 함)', '소비자기본법' 등 관계 법령(이하 '관계법령' 이라 함)에 위배되지 않는 범위 내에서 이 약관을 변경할 수 있으며, 회사는 약관이 변경되는 경우에 변경된 약관의 내용과 시행일을 정하여, 그 시행일로부터 최소 7일 (이용자에게 불리하거나 중대한 사항의 변경은 30일) 이전부터 시행일 후 상당한 기간 동안 공지하고, 기존 이용자에게는 변경된 약관, 적용일자 및 변경사유(변경될 내용 중 중요사항에 대한 설명을 포함)를 별도의 전자적 수단(전자우편, 문자메시지, 서비스 내 전자쪽지발송, 알림 메시지를 띄우는 등의 방법)으로 개별 통지합니다. 변경된 약관은 공지하거나 통지한 시행일로부터 효력이 발생합니다.",
        ...
        <TermsSection
          title="제6조(이용계약의 체결)"
          description="이용계약은 다음의 경우에 체결됩니다."
          contents={[
        ...
        <TermsSection
          ...
          contents={[
            ...
            [
              "버전 관리 시스템 플랫폼 연동 연구노트 자동 생성 기능 제공",
              "특정 파일에 대한 연구노트 생성 및 보관",
              "연구노트를 팀 단위로 공유 및 참여 기능 제공",
              "사용자의 연구노트를 블록체인 기술을 이용한 시점 인증 기능 제공",
              "사용자의 연구노트를 위조, 변조 여부 확인 기능 제공",
            ],
          ]}
        />
        <TermsSection
        ...
        <TermsSection
          ...
          contents={[
            ...
            "회사는 환불 의무가 발생한 날로부터 2영업일 내에 환불 절차 유효 여부를 이용자에게 안내합니다. 환불 요청이 유효할 경우, 안내일로부터 1영업일 이내에 환불절차를 진행합니다. 다만, 환불을 위하여 이용자의 협조가 필요한 경우 이용자의 귀책사유로 환불이 지연된 경우 회사는 지연이자를 부담하지 않습니다.",
        ...
        />
        <TermsSection
          title="제23조(관할법원 및 준거법)"
          description="서비스와 관련하여 분쟁이 발생한 경우 관할법원은 회사 소재지 관할법원으로 정하며, 준거법은 대한민국의 법령을 적용합니다."
          contents={[
