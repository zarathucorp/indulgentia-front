import TermsSection from "@/components/modules/help/termsSection"

export default function TermsConditions() {
  return (
		<div className="container mx-auto">
			<div className="max-w-3xl mx-auto">
				<h1 className="text-3xl font-bold my-4 text-gray-900 dark:text-gray-100">개인정보처리방침</h1>
        <TermsSection
          title="제1조(목적)"
          description="차라투 주식회사(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="개인정보 관련 법령 및 본 방침에 따라 회사는 이용자의 개인정보를 수집할 수 있으며 수집된 개인정보는 개인의 동의가 있는 경우에 한해 제3자에게 제공될 수 있습니다. 단, 법령의 규정 등에 의해 적법하게 강제되는 경우 회사는 수집한 이용자의 개인정보를 사전에 개인의 동의 없이 제3자에게 제공할 수도 있습니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다."
          contents={[
        ...
        <TermsSection
          title="제8조(개인정보의 이용)"
          description="회사는 개인정보를 다음 각 호의 경우에 이용합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다."
          contents={[
        ...
        <TermsSection
          title="제13조(개인정보파기방법)"
          description="회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하며, 종이로 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조, 훼손 등이 되지 아니하도록 안전성을 확보하기 위하여 필요한 기술적·관리적 보호대책을 강구하고 있습니다."
          contents={[
        ...
        <TermsSection
          ...
          description={`회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 회사가 수집하는 "개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.`}
          contents={[
        ...
        <TermsSection
          ...
          description="이용자의 비밀번호는 일방향 암호화하여 저장 및 관리되고 있으며, 개인정보의 확인, 변경은 비밀번호를 알고 있는 본인에 의해서만 가능합니다."
          contents={[
        ...
        <TermsSection
          ...
          description="회사는 개인정보 관련 처리 담당자를 최소한으로 제한하며, 개인정보 처리자에 대한 교육 등 관리적 조치를 통해 법령 및 내부방침 등의 준수를 강조하고 있습니다."
          contents={[
        ...
        <TermsSection
          ...
          description={`회사는 개인정보의 분실·도난·유출(이하 "유출 등"이라 한다) 사실을 안 때에는 지체 없이 다음 각 호의 모든 사항을 해당 이용자에게 알리고 방송통신위원회 또는 한국인터넷진흥원에 신고합니다.`}
          contents={[
            "유출 등이 된 개인정보 항목",
            "유출 등이 발생한 시점",
            "이용자가 취할 수 있는 조치",
        ...
        <TermsSection
          ...
          description="회사는 전조에도 불구하고 이용자의 연락처를 알 수 없는 등 정당한 사유가 있는 경우에는 회사의 홈페이지에 30일 이상 게시하는 방법으로 전조의 통지를 갈음하는 조치를 취할 수 있습니다."
          contents={[
        ...
        <TermsSection
          ...
          description="웹브라우저 옵션 설정을 통해 쿠키 허용, 쿠키 차단 등의 설정을 할 수 있습니다."
          contents={[
        ...
        />
        <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100 my-6"><i>부 칙</i></h3>
        <TermsSection
          title="제1조(시행일)"
          description="본 약관은 2024.11.05.부터 시행됩니다. "
          contents={[
