...
export default function BucketCreateBreadCrumb() {
  const searchParams = useSearchParams();
    ...
    <div className="py-3 pl-4">
      {isBreadcrumbLoading ? (
        ...
        breadcrumbData && <DashboardBreadCrumb breadcrumbData={{ level: "Bucket", project_id: breadcrumbData.id, project_title: breadcrumbData.title, bucket_title: "[새 버킷]", bucket_id: "" }} />
      )}
    </div>
	);
}
