...
import BucketdownloadForm from "@/components/modules/demo/dashboard/project/BucketdownloadForm";
            ...
            >
              <Button
                onClick={() => {
                  toast({
                    title: "프로젝트 설정",
                    description: `데모 페이지에서는 프로젝트 설정 기능을 지원하지 않습니다.`,
                  });
                }}
                variant={"outline"}
            ...
            >
              <Button
                onClick={() => {
                  toast({
                    title: "버킷 생성",
                    description: `데모 페이지에서는 버킷 생성 기능을 지원하지 않습니다.`,
                  });
                }}
                className="w-full "
              >
                  ...
                  >
                    ...
                    <TableCell>
                      {toggleDownload ? (
                        ...
                        <Link href={`/demo/dashboard/bucket/${bucket.id}`}>
