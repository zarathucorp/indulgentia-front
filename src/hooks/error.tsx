...
const ERROR_CODE = {
	...
	A3: {
		...
		"100": { message: "비정상적인 접근으로 인해 접근이 제한되었습니다" },
		"110": { message: "요청이 너무 많아 접근이 제한되었습니다" },
		"111": { message: "같은 IP에서 요청이 너무 많아 접근이 제한되었습니다" },
		"112": { message: "같은 사용자로부터 요청이 너무 많아 접근이 제한되었습니다" },

		"120": { message: "위조된 요청으로 접근이 제한되었습니다" },
		"121": { message: "위조된 요청 헤더로 접근이 제한되었습니다" },
		"122": { message: "위조된 요청 본문으로 접근이 제한되었습니다" },
		"123": { message: "위조된 요청 방법으로 접근이 제한되었습니다" },
		"124": { message: "위조된 쿠키로 접근이 제한되었습니다" },

		"200": { message: "사용자 접근이 접근이 제한되었습니다" },
		"210": { message: "쿠키로 인해 접근이 제한되었습니다" },
		"211": { message: "쿠키를 찾을 수 없어 접근이 제한되었습니다" },
		"212": { message: "쿠키가 만료되어 접근이 제한되었습니다" },
		"213": { message: "쿠키에 사용자가 없어 접근이 제한되었습니다" },
	},
